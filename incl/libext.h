...
size_t				ft_strclenrevr(char *str, char stop,
...
t_tree				*ft_treebfirst(t_tree *root, int (*f)(void *item,
						void *cmp), t_list *queue, void *cmp);
t_tree				*ft_treenew(void *item);
void				ft_treeprint(t_tree *root, void (*print)(void *item));

HEAP				*ft_dlstnew(void *item, void *prev);
void				ft_dlstdel(t_dlist **head, t_dlist *del,
						void (*f)(void *item));
void				ft_dlstclearright(t_dlist **head, t_dlist
						*elem, void (*f)(void *item));
void				ft_dlstclearleft(t_dlist **head, t_dlist *elem,
						void (*f)(void *item));
...
void				ft_lstdel(t_list **list, t_list *elem,
						void (*del)(void *item));
